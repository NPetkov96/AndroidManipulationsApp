        ...
        public static ObservableCollection<MedicalProcedureViewModel> GetAllProcedures()
        {
            return new ObservableCollection<MedicalProcedureViewModel>
            {
               new MedicalProcedureViewModel { Name = "Здравна книжка", Price = 25.0m },
                ...
                new MedicalProcedureViewModel { Name = "Предоперативен – оптимален", Price = 82.0m },
                ...
                new MedicalProcedureViewModel { Name = "D-Dimer", Price = 25.0m },
                ...
                new MedicalProcedureViewModel { Name = "Калций (Ca)", Price = 3.5m },
                ...
                new MedicalProcedureViewModel { Name = "Общо химично изследване и седимент", Price = 4.5m },
